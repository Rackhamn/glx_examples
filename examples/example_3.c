// 2022-08-09
// Example 3: OpenGL X11 Tetrahedron render inside of FPS loop.
// gcc -std=c99 -g example_3.c ../common/timing.c ../common/mat4.c -D_GNU_SOURCE -lm -lX11 -lXrandr -lXext -lGL -lGLU -o example; ./example
#define TITLE	"glx example 3"
...
int main(int argc, char ** argv) {
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(struct vertex) * tetrahedron_vertices, tetrahedron_meshdata, GL_STATIC_DRAW);
	...
	while(frames_left > 0) {
		...
		while(i < mcount) {			
			...
			glDrawArrays(GL_TRIANGLES, 0, tetrahedron_vertices);
